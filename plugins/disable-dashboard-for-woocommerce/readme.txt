...
== Disable unnecessary WooCommerce features and make your shop faster and cleaner ==
...
= 2.6.4 =
- Fixed issue with options not working properly when Disable WooCommerce Admin option is unchecked
- Fixed fatal error on the WordPress Dashboard screen with WooCommerce 6.2.0 on multisite

= 2.6.3 =
- Fixed issue with WooCommerce Status Meta Box Dashboard Widget not showing in some cases

= 2.6.2 =
- Fixed fatal error on the WordPress Dashboard screen with WooCommerce 6.2.0

= 2.6.1 =
- Minor text changes

= 2.6.0 =
- Added option to remove WooCommerce Dashboard Setup Widget
- Added option to remove My Subscriptions submenu

= 2.5.3 =
- Fixed warning related to WooCommerce version check
- Fixed disabling WC-admin message on the old Reports page

= 2.5.2 =
- Added better compatibility with WooCommerce 5.6

= 2.5.1 =
- Added compatibility with WooCommerce 5.6
