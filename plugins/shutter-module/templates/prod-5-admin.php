...
<!--                            </div>-->
                            ...
                            <div class="col-sm-2">
                                Total (cb/m):
                                <input id="property_total" name="property_total" type="text" value="<?php echo get_post_meta($product_id, 'property_volume', true); ?>"
                                />
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top:1em;">
                            ...
                            <div class="col-sm-3">
                                Material:
                                <br/>
                                <input class="property-select required" id="property_material" name="property_material" type="hidden" value="<?php echo get_post_meta($product_id, 'property_material', true); ?>"/>
                            ...
                            <div class="col-sm-2">
                                Colour:
                                <br/>
                                <input class="property-select" id="property_shuttercolour" name="property_shuttercolour" type="hidden" value="<?php echo get_post_meta($product_id, 'property_shuttercolour', true); ?>"
                                />
                            </div>
