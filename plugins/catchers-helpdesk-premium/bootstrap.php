...
define('STG_HELPDESK_VERSION', '2.6.7');
if(!defined('STG_HELPDESK_NAME')) {
    define('STG_HELPDESK_NAME', 'catchers-helpdesk-premium');
    define('STG_HELPDESK_TEXT_DOMAIN_NAME', 'catchers-helpdesk-premium');
}
...
define('STG_HELPDESK_SHORTCODE_KB', 'stgh-kb');
