...
<div class="inside">
    ...
    <div id="stgh-crm-select-form">
        ...
        <!-- START contact from orders -->
        <strong><?php _e('Order reference', STG_HELPDESK_TEXT_DOMAIN_NAME); ?>:</strong>
            &nbsp;
            <input id="stgh-contact-order-crm-autocomplete" type="text" name="customer_order"
                   placeholder="<?php _e('Enter order reference', STG_HELPDESK_TEXT_DOMAIN_NAME)?>"
                   value=""/>
        <!-- END contact from orders -->

        <button class="get_order_ref_data btn btn-default btn-small small">Get Order</button>
            ...
            <?php do_action('stgh_agent_crm_right'); ?>

            <a id="toggleCcBcc"><u><?php _e('Cc/Bcc', STG_HELPDESK_TEXT_DOMAIN_NAME); ?></u></a>
