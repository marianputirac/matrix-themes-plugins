...
class AdapterEnvato
{
    ...
    public function __construct($envatoToken,$envatoProductId,$license,$currentVersion,$pluginSlug)
    {
    ...
    public function getPluginInfoFromMycatchers($version = false){
        /**
         * @var AdapterMycatchers $updateAdapter
         */
        $updateAdapter = AdapterFactory::getAdapter('Mycatchers',array( 'license' => $this->_license ),$this->_currentVersion, $this->_pluginSlug);
