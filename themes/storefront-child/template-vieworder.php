...
?>
    ...
    <div class="woocommerce-order">
        ...
        $cart_id = get_post_meta($order->ID, 'cart_id', true);
                ...
                <div class="col-xs-12">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable table-loose"
                        ...
                        <tr>
                            ...
                            <td colspan="9"><?php echo get_post_meta($order->ID, 'cart_name', true); ?></td>
                        </tr>
                        </tbody>
                    </table>
...
echo do_shortcode('[display_factory_queries order_id="' . $order->ID . '"]');
